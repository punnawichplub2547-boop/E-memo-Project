...
- DB-2 has started: new memo creation (`ADD_MEMO`), approval advancement (`ADVANCE_STEP`), and return-for-revision (`RETURN_MEMO`) are persisted to MySQL; reject, read, and revision mutations still stay in memory.
