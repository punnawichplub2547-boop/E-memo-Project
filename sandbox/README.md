...
- DB-2 has started: new memo creation (`ADD_MEMO`) and approval advancement (`ADVANCE_STEP`) are persisted to MySQL, while later workflow mutations still stay in memory.
